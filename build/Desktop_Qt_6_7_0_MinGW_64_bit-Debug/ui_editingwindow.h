...
public:
    ...
    void setupUi(QWidget *EditingWindow)
    {
        ...
        EditingWindow->resize(400, 400);
        EditingWindow->setMinimumSize(QSize(400, 400));
        EditingWindow->setMaximumSize(QSize(400, 400));
...
"background-color: white; color: black;"));
        ...
        pushButton_save->setGeometry(QRect(210, 353, 80, 31));
