...
public:
    ...
    void setupUi(QMainWindow *RequestDescriptionWindow)
    {
        ...
        RequestDescriptionWindow->resize(400, 460);
        RequestDescriptionWindow->setMinimumSize(QSize(400, 460));
        RequestDescriptionWindow->setMaximumSize(QSize(400, 460));
        ...
        textBrowser_applicationID->setGeometry(QRect(130, 80, 256, 21));
        ...
        textBrowser_typeOfFault->setGeometry(QRect(130, 200, 256, 21));
        ...
        label_customer_worker->setGeometry(QRect(60, 20, 71, 16));
        textBrowser_worker = new QTextBrowser(centralwidget);
        textBrowser_worker->setObjectName("textBrowser_worker");
        textBrowser_worker->setGeometry(QRect(130, 20, 256, 21));
